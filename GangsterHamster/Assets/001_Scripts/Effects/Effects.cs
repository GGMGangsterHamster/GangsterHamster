...
namespace Effects
{
    ...
    /// </summary>
    abstract public class Effects<T, GlobalVolume> : MonoSingleton<T> where T : MonoBehaviour where GlobalVolume : VolumeComponentWithQuality
    {
        ...
        protected void Tween(Action initalize, Action step, Func<bool> compare, Action callback = null) {

            if(_coroutine != null) { // 이미 재생중인 경우
